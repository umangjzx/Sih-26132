...
**Status — Phases 1–3 complete, plus v1.1 through v1.23 (last updated 2026-09-08):**
...
Database: PostgreSQL 16, 20 tables, 20 linear Alembic migrations. 11 free
...
│   ├── alembic/versions/       20 revisions, 0001_initial → c72976cb1109_v1_23_pool_forward_race_guards
│   │                           (see Database schema → Migrations for the full chain)
│   ├── tests/                  pytest suite (SQLite in-memory) — 42 test files, 477 tests
│   └── .env.example
├── frontend/
│   └── src/
...
**Backend** (42 test files, 477 tests): signal cases and MSP/weather factors;
