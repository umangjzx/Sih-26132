...
**Status — Phases 1–3 complete, plus v1.1 through v1.36 (last updated 2026-09-08):**
...
Database: PostgreSQL 16, 20 tables, 26 linear Alembic migrations. 11 free
...
│   ├── alembic/versions/       26 revisions, 0001_initial → e2a6c4f7b1d9_v1_36_geo_bbox_indexes
│   │                           (see Database schema → Migrations for the full chain)
│   ├── tests/                  pytest suite (SQLite in-memory) — 42 test files, 497 tests
│   └── .env.example
├── frontend/
│   └── src/
...
**Backend** (42 test files, 497 tests): signal cases and MSP/weather factors;
