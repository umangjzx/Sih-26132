...
**Status — Phases 1–3 complete, plus v1.1 through v1.26 (last updated 2026-09-08):**
...
Database: PostgreSQL 16, 20 tables, 23 linear Alembic migrations. 11 free
...
│   ├── alembic/versions/       23 revisions, 0001_initial → 9a5917ab05cd_v1_26_price_alert_dedup_guard
│   │                           (see Database schema → Migrations for the full chain)
│   ├── tests/                  pytest suite (SQLite in-memory) — 42 test files, 481 tests
│   └── .env.example
├── frontend/
│   └── src/
...
**Backend** (42 test files, 481 tests): signal cases and MSP/weather factors;
