...
**Status — Phases 1–3 complete, plus v1.1 through v1.25 (last updated 2026-09-08):**
...
Database: PostgreSQL 16, 20 tables, 22 linear Alembic migrations. 11 free
...
│   ├── alembic/versions/       22 revisions, 0001_initial → 62fd33ddca7e_v1_25_offer_dispute_race_guards
│   │                           (see Database schema → Migrations for the full chain)
│   ├── tests/                  pytest suite (SQLite in-memory) — 42 test files, 480 tests
│   └── .env.example
├── frontend/
│   └── src/
...
**Backend** (42 test files, 480 tests): signal cases and MSP/weather factors;
