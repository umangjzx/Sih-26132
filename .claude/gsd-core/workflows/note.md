...
- **Global scope**: `C:/Users/UMANG JAISWAL N/OneDrive/Desktop/SIH-21632/agrilink/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/UMANG JAISWAL N/OneDrive/Desktop/SIH-21632/agrilink/.claude/notes/`)
...
2. Glob `C:/Users/UMANG JAISWAL N/OneDrive/Desktop/SIH-21632/agrilink/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/UMANG JAISWAL N/OneDrive/Desktop/SIH-21632/agrilink/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/UMANG JAISWAL N/OneDrive/Desktop/SIH-21632/agrilink/.claude/notes/` — works in any directory
