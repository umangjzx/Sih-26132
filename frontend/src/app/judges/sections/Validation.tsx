...
export function ValidationSection() {
  return (
    <JudgeSection
      ...
      quickAnswer="554 automated tests, run to completion by hand for this page on 2026-09-08: 503/503 backend (pytest) + 51/51 frontend (vitest) — both 100% passing. No performance/security test suite exists yet; that gap is disclosed honestly in Performance and Security below rather than papered over."
    >
      <div className="mb-8 grid gap-4 sm:grid-cols-3">
        <div className="al-card-plain p-5 text-center">
          <span className="font-heading text-3xl font-extrabold text-[var(--green-700)]">503 / 503</span>
          <p className="mt-1 text-xs text-[var(--ink-soft)]">Backend tests passing (pytest, 43 files) — run live for this page</p>
        </div>
        <div className="al-card-plain p-5 text-center">
      ...
      <div className="mt-3 grid gap-3 sm:grid-cols-3">
        {[
          ...
          { name: "Performance testing", detail: "No k6/Locust run against a deployed instance yet, but two local tools have run against real Postgres data: a fixed-load benchmark (scripts/perf_bench.py, re-run 2026-09-07, found and fixed one real bottleneck) and a concurrency-ramp load test (scripts/load_test.py, 2026-09-08, found this deployment's real saturation point) — see Performance", evidence: "verified" as const },
