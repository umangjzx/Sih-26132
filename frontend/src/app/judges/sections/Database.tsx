...
const TABLES = [
  ...
  { name: "lots", purpose: "Produce a farmer has listed for sale", fields: "farmer_id→users, crop, quantity_kg, quality_grade, photo_url?, photo_thumb_url?, expected_price, available_from, location, lat/lon?", rel: "Scored against demands into matches; can join a pool", source: "Farmer form (optionally OCR-drafted)" },
...
export function DatabaseSection() {
  return (
    <JudgeSection
      id="database"
      eyebrow="Data model"
      title="Database design — 20 tables, 27 migrations"
