...
const SCORES = [
  {
    ...
    pct: 95,
    evidence: "Calculated: production build compiles clean across 31 routes, 540/540 automated tests pass, zero raw-SQL/injection risk found in a full-codebase grep. Docked 5% for the doc staleness this audit found and corrected.",
  },
  {
  ...
  },
  {
    ...
    pct: 85,
    evidence: "Manually assessed from: 540 passing tests across 56 files covering every domain (auth through forward contracts and financing), plus a local performance benchmark and two security scanners run this session — docked for no formal UAT script and no production-scale load test yet.",
  },
  {
...
const SUMMARY = [
  ...
  { label: "Technical Strength", text: "111 real endpoints, a 20-table relational schema under Alembic, 540/540 tests passing, and 11 external integrations that all degrade gracefully." },
...
const WHY = [
  "540 of 540 automated tests pass — verified by running both suites live, not quoted from a stale document",
