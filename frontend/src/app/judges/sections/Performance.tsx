...
const METRICS = [
  ...
  { metric: "Error rate", value: "0 failures across 552 automated test runs (not the same as a production error rate)", kind: "verified" as const },
  { metric: "Uptime", value: "Not applicable — no long-running production deployment with an SLA yet", kind: "pending" as const },
  { metric: "Backend test-suite runtime", value: "501 tests in 38.0s (in-memory SQLite, run 2026-09-08 alongside a live dev server — runtime varies with what else is running on the machine)", kind: "verified" as const },
