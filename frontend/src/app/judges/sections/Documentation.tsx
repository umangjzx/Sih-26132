...
const DOCS = [
  ...
  { icon: "shield", name: "Database migrations (source of truth for schema history)", desc: "19 Alembic revisions, browsable in order", href: `${REPO}/backend/alembic/versions` },
];
