...
const DOCS = [
  ...
  { icon: "shield", name: "Database migrations (source of truth for schema history)", desc: "20 Alembic revisions, browsable in order", href: `${REPO}/backend/alembic/versions` },
];
