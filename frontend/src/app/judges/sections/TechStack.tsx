...
const STACK: { category: string; icon: string; items: Tech[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Alembic", version: "1.19.1", why: "Every schema change is a reviewable, revertible migration — 20 revisions, linear chain, no drift between environments", alt: "—" },
      ...
      { name: "pytest", version: "9.1.1", why: "477 backend tests run against an in-memory SQLite DB — no container needed to run the suite", alt: "—" },
    ],
  },
  {
    category: "Database",
