...
const FAQS = [
  ...
  { q: "What is your biggest technical challenge?", a: "Keeping 8+ independent external data sources offline-safe without the app ever looking broken when one is unreachable — and separately, enforcing 100% trilingual parity (1,200 keys × 3 languages) automatically so a missing translation is a build failure, not a live bug." },
