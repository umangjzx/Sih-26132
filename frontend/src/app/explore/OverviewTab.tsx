...
/** "State Overview" tab of the Market Intelligence hub — formerly the whole
 * /explore page. Public statewide price-transparency dashboard: movers,
 * district gaps, and the anonymised realisation aggregate. No login needed. */
