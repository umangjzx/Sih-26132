    ...
    <div className="-mx-4 -mt-6 flex min-h-[calc(100vh-80px)] sm:-mx-6 lg:-mx-8">
      ...
      >
        ...
        <div className="relative z-10 flex flex-1 flex-col justify-center px-12 py-16 xl:px-16">
          ...
          {/* Styled tagline, not a document heading — the page's one <h1> is
              the "Sign in" / "Create account" title in the form panel. */}
          <p className="font-heading text-3xl font-extrabold leading-snug text-white xl:text-4xl">
            Real prices.{" "}
