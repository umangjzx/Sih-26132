...
/**
 * "Discover" tab of the Marketplace hub — formerly the whole /browse page.
 * A buyer browses nearby open lots, a farmer browses nearby open demands.
 * Radius-filtered against the viewer's profile location.
 */
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        <input
          ...
          className="rounded-xl border border-[var(--line)] px-3 py-2.5 text-sm focus:border-[var(--green-600)] focus:outline-none focus:ring-2 focus:ring-[var(--green-600)]/30"
        />
        <button
          type="button"
          onClick={() => setWide((w) => !w)}
